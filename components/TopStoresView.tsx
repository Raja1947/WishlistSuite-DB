...
export default function TopStoresView({ stores }: { stores: StoreRow[] }) {
  ...
  function exportCSV() {
    ...
    a.download = `top-stores-${period}days.csv`;
    a.click();
  }
    ...
    <div className="min-h-screen px-6 py-8" style={{ background: "#080808" }}>
      <div className="max-w-screen-xl mx-auto">
        ...
        <div className="flex items-start justify-between mb-6 flex-wrap gap-4">
          <div>
            <h1 className="text-3xl font-bold text-white">Top Performing Stores ({filtered.length})</h1>
            <p className="text-zinc-500 text-sm mt-1">Stores ranked by wishlist revenue</p>
          </div>
              ...
              <tbody>
                {filtered.map((s, i) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-zinc-300 whitespace-nowrap">{formatCurrency(s.revenue, s.currencyCode)}</td>
